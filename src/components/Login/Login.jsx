		...
		<div>
			<Formik>
				<Form onSubmit={formik.handleSubmit}>
					<div>
						<Field type={"email"} name={"email"} placeholder={"Enter email"} onChange={formik.handleChange} onBlur={formik.handleBlur} />
					</div>
					{formik.errors.email && formik.touched.email ? <p className={s.error}>Required</p> : null}
					<div>
